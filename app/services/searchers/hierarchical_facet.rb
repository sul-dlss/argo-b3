...
module Searchers
  ...
  class HierarchicalFacet
    ...
    def initialize(search_form:, facet_config:, workgroups:, value: nil, # rubocop:disable Metrics/ParameterLists
                   limit: nil, page: nil)
    ...
    attr_reader :search_form, :facet_config, :workgroups, :limit, :value, :page

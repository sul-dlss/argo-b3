...
module Searchers
  ...
  class FacetQuery
    ...
    def initialize(search_form:, field:, facet_query:, workgroups:, # rubocop:disable Metrics/ParameterLists
                   alpha_sort: false, limit: nil)
    ...
    attr_reader :search_form, :field, :workgroups, :alpha_sort, :limit, :facet_query

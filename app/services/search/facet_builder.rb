...
module Search
  ...
  class FacetBuilder
    ...
    def initialize(field:, alpha_sort: false, limit: nil, facet_query: nil, facet_prefix: nil, exclude: false) # rubocop:disable Metrics/ParameterLists
      @field = field
    ...
    attr_reader :field, :alpha_sort, :limit, :facet_query, :facet_prefix, :exclude
  end
end

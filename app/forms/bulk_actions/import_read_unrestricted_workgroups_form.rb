...
module BulkActions
  # Form object for import read unrestricted workgroups bulk action.
  class ImportReadUnrestrictedWorkgroupsForm < BasicCsvForm
    REQUIRED_HEADERS = %w[workgroup read_unrestricted].freeze

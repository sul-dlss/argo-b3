...
RSpec.describe Sdr::WorkflowService do
  ...
  describe '#workflows_for' do
    ...
    it 'returns two workflow response objects' do
      expect(service.first.workflow_name).to eq('accessionWF')
      expect(service.first).to be_complete
      expect(service.first.error_count).to be_zero
      expect(service.second.workflow_name).to eq('assemblyWF')
      expect(service.second).not_to be_complete
      expect(service.second.error_count).to eq(1)
    end
  end
  ...
  describe '#accessioned?' do
    ...
    context 'when the accessioned lifecycle exists' do
    ...
    context 'when the accessioned lifecycle does not exist' do
  ...
  describe '#submitted' do
    ...
    context 'when the submitted lifecycle exists' do
    ...
    context 'when the submitted lifecycle does not exist' do
  ...
  describe '#published' do
    ...
    context 'when the published lifecycle exists' do
    ...
    context 'when the published lifecycle does not exist' do

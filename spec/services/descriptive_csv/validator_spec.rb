...
RSpec.describe DescriptiveCsv::Validator do
  describe '#valid?' do
    let(:instance) { described_class.new(CSV.parse(csv, headers: true)) }

    context 'with all jobs' do
      ...
      context 'with mismatched structured title1.structuredValue columns' do
        let(:csv) do
          'druid,title1.structuredValue1.type,title1.structuredValue1.value,title1.structuredValue12type,title1.structuredValue2.value' # rubocop:disable Layout/LineLength
        end
      ...
      context 'with mismatched structured title2.structuredValue columns' do
        let(:csv) do
          'druid,title1.structuredValue1.type,title1.structuredValue1.value,title2.structuredValue1.type,title2.structuredValue2.value' # rubocop:disable Layout/LineLength
        end
      ...
      context 'with another form of mismatched structured title2.structuredValue columns' do
        let(:csv) do
          'druid,title1.structuredValue1.type,title1.structuredValue1.value,title2.structuredValue2.type,title3.structuredValue2.value' # rubocop:disable Layout/LineLength
        end
      ...
      context 'with headers that do not map to cocina model' do
        let(:csv) do
          'druid,title1.value,title1.type,title2.value,title2.type,title3.value,title3.type,bogus,event.contributor,event1.contributor,event1.note1.source.value' # rubocop:disable Layout/LineLength
        end
